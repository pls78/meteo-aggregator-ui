# wms-proxy Specification

## Purpose
Same-origin edge forwarding of satellite WMS requests to the allow-listed
EUMETSAT upstream, so tile and legend loading never depends on the upstream's
CORS policy.
## Requirements
