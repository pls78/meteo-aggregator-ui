      ...
      <div className="flex items-center gap-2">
        ...
        {!comparison && (
          <button
            ...
            disabled={!primary}
            className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg border border-slate-300 bg-white/95 text-xl leading-none text-slate-600 shadow-lg hover:bg-white hover:text-slate-900 disabled:cursor-not-allowed disabled:opacity-40"
          >
            +
          </button>
        )}
