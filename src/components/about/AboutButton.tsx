...
export function AboutButton({ className = '' }: { className?: string }) {
  ...
  return (
    <button
      ...
      className={`panel grid place-items-center rounded-full text-ink-600 transition-colors hover:text-ink-900 focus-visible:outline-2 focus-visible:outline-accent ${className}`}
    >
