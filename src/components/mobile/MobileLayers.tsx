  ...
  return (
    <>
      <button
        ...
        className="pointer-events-auto absolute right-3 top-24 z-[1000] grid h-12 w-12 place-items-center rounded-2xl bg-white/75 text-slate-700 shadow-xl ring-1 ring-black/5 backdrop-blur"
      >
      ...
      <section
        aria-label="Satellite layers"
        className={`pointer-events-auto absolute inset-x-0 bottom-0 z-[1002] flex max-h-[74%] flex-col rounded-t-2xl bg-white/75 shadow-[0_-8px_30px_-8px_rgba(15,23,42,0.3)] backdrop-blur transition-transform duration-300 ${
