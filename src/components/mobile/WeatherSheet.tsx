...
export function WeatherSheet() {
  ...
  return (
    <section
      className="pointer-events-auto absolute inset-x-0 bottom-0 z-[1000] flex flex-col overflow-hidden rounded-t-2xl bg-white/80 shadow-[0_-8px_30px_-8px_rgba(15,23,42,0.28)] ring-1 ring-black/5 backdrop-blur"
